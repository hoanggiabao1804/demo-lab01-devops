def call(Map params) {
    ...
    stage('Gitleak Scan') {
        ...
        '  rating-gitleaks-report.json > rating-gitleaks-report.html
        '''
        ...
        def hasLeak = sh(
            script: '[ grep -q "RuleID" rating-gitleaks-report.json ]',
            returnStatus: true
        )
    ...
    stage('Snyk Scan') {
        ...
        ' rating-snyk-report.json > rating-snyk-report.html
        '''
        ...
        def hasVuln = sh(
            script: 'grep -q "vulnerabilities" rating-snyk-report.json',
            returnStatus: true
        )
