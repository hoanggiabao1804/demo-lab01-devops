def call(Map params) {
    ...
    stage('Gitleak Scan') {
        ...
        '  location-gitleaks-report.json > location-gitleaks-report.html
        '''
        ...
        def hasLeak = sh(
            script: '[ grep -q "RuleID" location-gitleaks-report.json ]',
            returnStatus: true
        )
    ...
    stage('Snyk Scan') {
        ...
        ' location-snyk-report.json > location-snyk-report.html
        '''
