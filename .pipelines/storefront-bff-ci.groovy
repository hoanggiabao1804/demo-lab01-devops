def call(Map params) {
    ...
    stage('Snyk Scan') {
        def jsonReport = 'reports/snyk/storefront-bff-snyk-report.json'
        def htmlReport = 'reports/snyk/storefront-bff-snyk-report.html'
        def snykExitCode = 2
        ...
        withCredentials([
            ...
            snykExitCode = sh(
                ...
                script: '''
                    ...
                    snyk test \
                        --file=storefront-bff/pom.xml \
                        --maven-skip-wrapper \
                        --org="$SNYK_ORG" \
                        --json-file-output=reports/snyk/storefront-bff-snyk-report.json \
                        -- \
                        -Drevision="$REVISION"
                '''
            )
    ...
    stage('Build and Push Docker Image') {
        ...
        docker build -t 23120022/yas-storefront-bff:$IMAGE_TAG ./storefront-bff

        docker push 23120022/yas-storefront-bff:$IMAGE_TAG
        '''
    }
}
