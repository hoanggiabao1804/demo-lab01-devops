def call(Map params) {
    ...
    stage('Snyk Scan') {
        def jsonReport = 'reports/snyk/webhook-snyk-report.json'
        def htmlReport = 'reports/snyk/webhook-snyk-report.html'
        def snykExitCode = 2
            ...
            snykExitCode = sh(
                ...
                script: '''
                    ...
                    snyk test \
                        ...
                        --maven-skip-wrapper \
                        --org="$SNYK_ORG" \
                        --json-file-output=reports/snyk/webhook-snyk-report.json \
                        -- \
                        -Drevision="$REVISION"
                '''
            )
