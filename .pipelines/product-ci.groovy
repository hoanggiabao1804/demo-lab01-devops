def call(Map params) {
    ...
    stage('Snyk Scan') {
        def jsonReport = 'reports/snyk/product-snyk-report.json'
        def htmlReport = 'reports/snyk/product-snyk-report.html'
        def snykExitCode = 2
            ...
            snykExitCode = sh(
                ...
                script: '''
                    ...
                    snyk test \
                        ...
                        --maven-skip-wrapper \
                        --org="$SNYK_ORG" \
                        --json-file-output=reports/snyk/product-snyk-report.json \
                        -- \
                        -Drevision="$REVISION"
                '''
            )
    ...
    stage('Build and Push Docker Image') {
        ...
        docker build -t 23120022/yas-product:$IMAGE_TAG ./product

        docker push 23120022/yas-product:$IMAGE_TAG
        '''
    }
}
