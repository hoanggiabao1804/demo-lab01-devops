def call(Map params) {
    ...
    stage('Gitleak Scan') {
        ...
        '  sampledata-gitleaks-report.json > sampledata-gitleaks-report.html
        '''
        ...
        def hasLeak = sh(
            script: '[ grep -q "RuleID" sampledata-gitleaks-report.json ]',
            returnStatus: true
        )
    ...
    stage('Snyk Scan') {
        ...
        ' sampledata-snyk-report.json > sampledata-snyk-report.html
        '''
        ...
        def hasVuln = sh(
            script: 'grep -q "vulnerabilities" sampledata-snyk-report.json',
            returnStatus: true
        )
