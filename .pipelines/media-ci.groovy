def call(Map params) {
    ...
    stage('Gitleak Scan') {
        ...
        '  media-gitleaks-report.json > media-gitleaks-report.html
        '''
        ...
        def hasLeak = sh(
            script: '[ grep -q "RuleID" media-gitleaks-report.json ]',
            returnStatus: true
        )
    ...
    stage('Snyk Scan') {
        ...
        ' media-snyk-report.json > media-snyk-report.html
        '''
        ...
        def hasVuln = sh(
            script: 'grep -q "vulnerabilities" media-snyk-report.json',
            returnStatus: true
        )
