def call(Map params) {
    ...
    stage('Publish Coverage Report') {
        publishHTML([
            ...
            reportName: 'Recommendation JaCoCo Coverage',
            keepAll: true,
    ...
    stage('Build and Push Docker Image') {
        ...
        docker build -t 23120022/yas-recommendation:$IMAGE_TAG ./recommendation

        docker push 23120022/yas-recommendation:$IMAGE_TAG
        '''
    }
}
