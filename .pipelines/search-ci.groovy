def call(Map params) {
    ...
    stage('Snyk Scan') {
        def jsonReport = 'reports/snyk/search-snyk-report.json'
        def htmlReport = 'reports/snyk/search-snyk-report.html'
        def snykExitCode = 2
            ...
            snykExitCode = sh(
                ...
                script: '''
                    ...
                    snyk test \
                        ...
                        --maven-skip-wrapper \
                        --org="$SNYK_ORG" \
                        --json-file-output=reports/snyk/search-snyk-report.json \
                        -- \
                        -Drevision="$REVISION"
                '''
            )
    ...
    stage('Build and Push Docker Image') {
        ...
        docker build -t 23120022/yas-search:$IMAGE_TAG ./search

        docker push 23120022/yas-search:$IMAGE_TAG
        '''
    }
}
